...
const legionesAstartes: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const shatteredLegions: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const cultMechanicum: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const knightsQuestoris: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const collegiaTitanica: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const solarAuxilia: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const imperialisMilitia: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const silentSisterhood: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const legioCustodes: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const ruinstormDaemons: ThemeConfig = {
  colors: {
    appBackground: "",
    appForeground: "",
    primary: "",
...
const appThemes = {
  light: lightTheme,
  dark: darkTheme,
  legionesAstartes: legionesAstartes,
  shatteredLegions: shatteredLegions,
  cultMechanicum: cultMechanicum,
  knightsQuestoris: knightsQuestoris,
  collegiaTitanica: collegiaTitanica,
  solarAuxilia: solarAuxilia,
  imperialisMilitia: imperialisMilitia,
  silentSisterhood: silentSisterhood,
  legioCustodes: legioCustodes,
  ruinstormDaemons: ruinstormDaemons,
};
